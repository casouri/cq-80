...
* Printing PCB boards
There are two boards to print, the main board (=/board=) and the USB breakout board (=/usb_breakout=). I used [[https://oshpark.com/][OSHPARK]] to print PCB boards. There are cheaper providers that I haven’t tried like [[https://www.pcbway.com/][pcbway]] and [[https://jlcpcb.com/][jlcpcb]].
...
Printed PCB boards:
- <<main board>> Main board (=/board/upload.zip=)
- <<usb breakout>> USB breakout (=/usb_breakout/upload.zip=)
